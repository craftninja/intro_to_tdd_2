...
describe BufferedLogger do
  ...
  it "writes more stuff to the text file once there are 5 more logs (10 total, 15 total...)" do
    buff_log=BufferedLogger.new
    buff_log.new_log("I coded in ruby all day... fun!", Date.new(2014, 3, 10))
    buff_log.new_log("I hit a wall... time to make some tea.", Date.new(2014, 3, 11))
    buff_log.new_log("I coded in ruby all day... fun!", Date.new(2014, 3, 12))
    buff_log.new_log("I hit a wall... time to make some tea.", Date.new(2014, 3, 13))
    buff_log.new_log("I coded in ruby all day... fun!", Date.new(2014, 3, 14))
    buff_log.new_log("I coded in ruby all day... fun!", Date.new(2014, 3, 15))
    buff_log.new_log("I hit a wall... time to make some tea.", Date.new(2014, 3, 16))
    buff_log.new_log("I coded in ruby all day... fun!", Date.new(2014, 3, 17))
    buff_log.new_log("I hit a wall... time to make some tea.", Date.new(2014, 3, 18))
    buff_log.new_log("I coded in ruby all day... fun!", Date.new(2014, 3, 19))
    expected = "2014-03-10T00:00 - I coded in ruby all day... fun!\n2014-03-11T00:00 - I hit a wall... time to make some tea.\n2014-03-12T00:00 - I coded in ruby all day... fun!\n2014-03-13T00:00 - I hit a wall... time to make some tea.\n2014-03-14T00:00 - I coded in ruby all day... fun!\n2014-03-15T00:00 - I coded in ruby all day... fun!\n2014-03-16T00:00 - I hit a wall... time to make some tea.\n2014-03-17T00:00 - I coded in ruby all day... fun!\n2014-03-18T00:00 - I hit a wall... time to make some tea.\n2014-03-19T00:00 - I coded in ruby all day... fun!\n"
    actual = File.read buff_log.filename
    expect(actual).to eq expected
